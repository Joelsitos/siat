...
<div style="height: 49.4%">
        ...
        <table class="table">
            <tr >
                <td class="td-border-none text-left" width="15%" ><b>Fecha: </b></td>
            ...
            <tr >
              ...
              <td class="td-border-none text-right" ><b></b></td>
              <td class="td-border-none">&nbsp;&nbsp;&nbsp;</td>
            </tr>
        </table>
        ...
        <table class="table2">
            ...
            <!-- <tr><td colspan="4" style="border-top:hidden;" valign="bottom"></td></tr> -->
